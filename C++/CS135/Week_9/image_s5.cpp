...
Latest Update: 04/03/2012 - 12:14 pm
...
void displayScreen()
  ...
  //initialize function and variables
    //variables
    int xLeft = 12, xRight = SCRN_MAX_X - 13;
    int yTop = 3, yBottom = SCRN_MAX_Y - 4;
    int titleX = 30;
    int titleY = 4;
  ...
  //print inner box
    ...
    //clear screen
      //function: clearScreen
      clearScreen( xLeft, yTop, xRight, yBottom);
    //print title 
      //printStringAt
      printStringAt( titleX, titleY, "Image Data Information", "LEFT");
  }
