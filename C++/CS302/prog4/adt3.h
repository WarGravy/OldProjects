...
public:
 ...
 ~iTreeType();                    // destructor
  ...
  bool IsFull() const;
  int GetLength() const; 
  ItemType GetItem(ItemType item, bool& found, int& swaps, int& comparisons);
  void PutItem(ItemType item, int& swaps, int& comparisons);
  void iDeleteItem(ItemType item, int& swaps, int& comparisons);
